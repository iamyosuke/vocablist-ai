...
export function VocabularyList({ t, onWordClick }: VocabularyListProps) {
  const { filteredItems } = useVocabularyStore();
    ...
    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 mb-24">
      {filteredItems.map((item) => (
        ...
        >
          ...
          <div className="text-sm text-gray-500 mt-4 border-t border-gray-100 pt-4 flex justify-between items-center">
            <span>
